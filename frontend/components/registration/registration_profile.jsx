...
// import Dropdown from '../dropdown/mentordropdown1';
import {useForm } from 'react-hook-form';
import {Link} from 'react-router-dom';
// import TableContainer from '../table/table_container'


const RegistrationProfile = ({userProfile, registration, updateRegistrationProfileObject, updateUserProfile, history}) => {
  ...
  const [company, setCompany] = useState('company');
    ...
    history.push("/matchingquestions")
    ...
    return (
            <div className="main_page_container">
              ...
              {/* <img src="" id="tableBanner" /> */}
                ...
                <h2 className="name-header">{registration.name}</h2>
                
                <form onSubmit={() => submit()}>
                  <label>Job Title
                    <input onChange={event => setJob(event.target.value)}type="text"/>
                  </label>
                  <label>Company
                    <input onChange={event => setCompany(event.target.vaue)}type="text"/>
                  </label>
                  ...
                  {
                    (registration.userType === "mentor") ? 
                  <label>About Me (i.e. what are you passionate about? What are your hobbies? What would you like to share with your mentee?)

                      <textarea cols="30" rows="10" onChange={event => setAboutMet(event.target.value)}></textarea>
                  </label>
                  : 
